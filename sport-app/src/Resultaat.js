        ...
        rug: [
          [
            ...
            <ol className="oefeningOL">
              ...
              <li className="orderedListItem">Til gecontroleerd je bovenlichaam van de grond en weer terug naar de startpositie</li>  
      ...
      <main className="oefeningen">
          ...
          {this.props.spiergroepen.map((x) => {
              ...
              <section key={`${x + 3}`} id={x} className="oefening">
                ...
                <p className="andereOefening">Bekijk een andere {x} oefening</p>
